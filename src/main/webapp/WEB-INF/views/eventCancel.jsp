	...
	<header>
	  <div class="container">
		...
		<h1>eZoo <small>Cancel Event</small></h1>
            ...
            <tbody>
               <tr>
                   <td width="50%" class="text-right">
                       <button formaction="${pageContext.request.contextPath }/event/cancel/${event.eventId}" formmethod="post" type="submit" class="btn btn-primary" >Cancel Event</button>
                    </td>
